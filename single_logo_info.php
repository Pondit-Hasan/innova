    ...
    <div class="col-lg-12 col-sm-12 m-auto py-3 my-2">
      <div class="card bg-light mb-3">
        <div class="card-header text-center">
          <h3 class="bg_header py-3">Single logo View!</h3>
        </div>
        <div class="card-body">
          <div class="bg-dark pt-2 pb-1 text-white text-center">
            <p class="mt-1"><a class="text-warning" href="edit_logo_info.php?id=<?php echo $afer_assoc['id'] ?>">Click here</a> to edit the information of the id#<?php echo $afer_assoc['id']; ?></p>
          </div>
          <table class="table card-text table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <?php
                  if($afer_assoc['logo_status']=="Active") {
                    echo "Active";
                  }else {
                    echo "Deactive";
                  }?>
              ...
              <tr>
                <th> logo Image </th>
                <td> <img class="medium_img" src="uploads/logoes/<?php echo $afer_assoc['logo_img']; ?>" alt="photo_<?php echo $afer_assoc['id']; ?>"> </td>
              </tr>
